        ...
        <div className="space-y-4 p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <span
                className={`flex items-center gap-1 rounded-full border px-2 py-1 text-xs ${googleConnected ? "border-green-200 bg-green-50 text-green-700" : "border-gray-200 bg-gray-50 text-gray-400"}`}
              >
            ...
            <div className="flex items-start gap-2 rounded border border-red-200 bg-red-50 p-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-red-700">
                  Conflicts with &quot;{overlapWarning.title}&quot; at{" "}
                  {overlapWarning.startTime}
                </p>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              placeholder="Event category / theme"
              onChange={(e) =>
          ...
          <div className="flex items-start gap-3">
            <AlignLeft className="mt-2 h-5 w-5 text-gray-500" />
            <textarea
            ...
            <div className="flex items-start gap-2 rounded-lg border border-blue-100 bg-blue-50 p-3 text-xs text-blue-700">
              ...
              <div>
                ...
                <p className="mt-0.5 text-blue-600">
                  The main event + all Weekly Content Calendar posts will be
          ...
          <div className="flex items-center justify-between gap-3 pt-2">
            {editingEventId && (
              <button
                ...
                disabled={deletingId === editingEventId}
                className="flex items-center gap-2 rounded bg-red-500 px-4 py-2 font-medium text-white transition-all hover:bg-red-600 disabled:opacity-60"
              >
                {deletingId === editingEventId ? (
                  <>
            ...
            <div className="ml-auto flex gap-3">
              <button
                onClick={onClose}
                className="rounded border-2 border-orange-500 px-6 py-2 font-medium text-orange-500 transition-all hover:bg-orange-50"
              >
                Cancel
              </button>
              <button
